...
namespace Collection
{
    public class Program
    {
        ...
        menu:
            ...
            Console.WriteLine("=====================");
            Console.WriteLine("1. Masukan Data Pegawai");
            ...
            if (pil == 1)
            {
                Console.WriteLine("1. Masukan Data Pegawai Tetap");
                Console.WriteLine("2. Masukan Data Pegawai Kontrak");
                Console.WriteLine("3. Masukan Data Sales");
